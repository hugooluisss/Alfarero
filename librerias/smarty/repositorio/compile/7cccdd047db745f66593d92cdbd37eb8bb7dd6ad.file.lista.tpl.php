<?php /* Smarty version Smarty-3.1.11, created on 2017-11-19 22:42:19
...
?>
					<tr>
						...
						<td style="text-align: right">
							<button type="button" class="btn btn-danger btn-xs" action="uploadPie" title="Subir pie de tarjetas" datos='<?php echo $_smarty_tpl->tpl_vars['row']->value['json'];?>
' data-toggle="modal" data-target="#winPieTarjeta"><i class="fa fa-upload"></i></button>
