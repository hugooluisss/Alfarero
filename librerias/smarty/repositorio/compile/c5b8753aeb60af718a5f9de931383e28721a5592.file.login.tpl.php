<?php /* Smarty version Smarty-3.1.11, created on 2017-10-02 22:18:39
         compiled from "templates/plantillas/layout/login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:210152375459d3018f3f2bb7-57206205%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '210152375459d3018f3f2bb7-57206205',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59d3018f557b08_04312561',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59d3018f557b08_04312561')) {function content_59d3018f557b08_04312561($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
	<meta charset="utf-8">
...
img/logo.png" class="img-responsive"/></center>
				...
				<form action="#" id="frmLogin" method="post">
					...
					<div class="row">
						<!-- /.col -->
						<div class="col-xs-12">
							<button type="submit" class="btn btn-warning btn-block">Iniciar</button>
						</div><!-- /.col -->
					</div>
				</form>		
			</div><!-- /.login-box-body -->
