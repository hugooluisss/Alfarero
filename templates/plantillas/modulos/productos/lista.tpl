				...
				{foreach from=$lista item="row"}
					<tr>
						...
						<td style="text-align: right">
							<button type="button" class="btn btn-danger btn-xs" action="uploadPie" title="Subir pie de tarjetas" datos='{$row.json}' data-toggle="modal" data-target="#winPieTarjeta"><i class="fa fa-upload"></i></button>
